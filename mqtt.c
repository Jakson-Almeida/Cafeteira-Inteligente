...
static mqtt_data_callback_t user_callback = NULL;
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:{
        ...
        mqtt_event_handler_cb(topic, data); // Chamada explícita
        break;
    }
...
void mqtt_start()
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .broker.address.uri = CONFIG_BROKER_URL, //"mqtt://mqtt.eclipse.org"
    };
